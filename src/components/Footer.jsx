...
const NAV_GROUPS = [
  {
    ...
    links: [
      ...
      { name: "Sobre mí",    section: "sobre-mi" },
...
export default function Footer({ T, dark }) {
  ...
  return (
    <footer className={styles.footer} style={{ background: bg, borderTop: `1px solid ${border}` }}>
      <div className={styles.gridBg} style={{ backgroundImage: `linear-gradient(${gridLine} 1px, transparent 1px), linear-gradient(90deg, ${gridLine} 1px, transparent 1px)` }} />
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.desc} style={{ color: textSub }}>
              Soluciones digitales a medida para empresas y emprendedores.
              Código limpio, diseño memorable, resultados reales.
            </p>
                ...
                <a
                  ...
                  style={{
                    background: hoveredSocial === s.name
                      ? (typeof s.bg === "string" && s.bg.startsWith("linear") ? s.bg : s.bg)
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.linkList}>
              {SERVICES_LIST.map((s) => (
                <li key={s}>
                  <button className={styles.footLink} style={{ color: textSub }} onClick={() => scrollToSection("servicios")}>
            ...
            <div key={group.label} className={styles.col}>
              ...
              <ul className={styles.linkList}>
                {group.links.map((link) => (
                  <li key={link.name}>
                    <button className={styles.footLink} style={{ color: textSub }} onClick={() => scrollToSection(link.section)}>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.contactList}>
              <li>
                <a href="https://wa.me/51960959529" target="_blank" rel="noopener noreferrer" className={styles.contactItem} style={{ color: textSub }}>
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.statusRow}>
            ...
            <span className={styles.statusText} style={{ color: textSub }}>Disponible para proyectos</span>
          </div>
          <div className={styles.madeWith} style={{ color: textSub }}>
            <span>Hecho con</span>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="#EA4B71"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
